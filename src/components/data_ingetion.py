...
if __name__=="__main__":
    ...
    x_train_arr,x_test_arr,_=data_transformation.initiate_data_transformation(train_data,test_data)



    modeltrainer=ModelTrainer()
    print(modeltrainer.initiate_model_trainer(x_train_arr,x_test_arr))
